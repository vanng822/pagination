...
Paginator.prototype = {
	calc : function() {
		...
		var previous = null, next = null, first = null, oldPageLinks = (pageLinks % 2 == 0) ? 1 : 0;
		var result = {
...
SearchPaginator.prototype.render = function() {
	var template = String(this.options.template);
...
var ItemPaginator = function(options) {
	Paginator.call(this, options);
	this.set('template', '{ObjectName} {DisplayedItemRange} of {TotalItems} {FirstPageLink} {PreviousPageLink} {NextPageLink} {LastPageLink}');
};
